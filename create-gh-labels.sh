...
# DORA priority
gh label create high -d "(DORA) This issue is very important"
gh label create medium -d "(DORA) This issue is of medium importants"
gh label create low -d "(DORA) This issue is not important"
